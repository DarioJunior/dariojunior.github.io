    ...
    return (
      <div id="CONTACT" className={styles.container}>
        ...
        <div className={styles.iconContainer}>
          ...
          <a className={styles.mediaIcon} rel="noreferrer" href="https://www.linkedin.com/in/dario-junior/" target="_blank">
            <img alt="Linkedin link" src="https://i.ibb.co/Kx2GSrT/linkedin.png" />
          </a>
          <a className={styles.mediaIcon} rel="noreferrer" href="https://www.instagram.com/dariojunior_" target="_blank">
